...
const ItemDetail = () => {
  ...
  <Grid container spacing={4} sx={{py: 5}}>
    ...
    {loading ? (
      <Item>
      <Skeleton sx={{ width: 500, minWidth:500}}/>
      <Skeleton sx={{ width: 500, minWidth:500}} animation="wave" />
      <Skeleton sx={{ width: 500, minWidth:500}} animation={false} />
      <Skeleton sx={{ height:150, width: 500, minWidth:500}} animation={false} />
